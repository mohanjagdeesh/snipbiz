  ...
  <div className="howitworks-main">
    ...
    <nav>
        <ul>
            ...
            <li>Forward Shipping</li>
            <li>US Debit Cards</li>
        </ul>
    </nav>
    ...
    <div className="howitworks-data">
        ...
        <div className="howitworks-process">
            ...
            <img src="https://res.cloudinary.com/dgkb0snud/image/upload/v1675771584/Rectangle_606hiw1_eyuyag.png" alt="howitworks-img"/>
        </div>

        <div className="howitworks-process">
            <img src="https://res.cloudinary.com/dgkb0snud/image/upload/v1675771584/Rectangle_606hiw2_lw193c.png" alt="howitworks-img"/>
        ...
        <div className="howitworks-process">
            ...
            <img src="https://res.cloudinary.com/dgkb0snud/image/upload/v1675771584/Rectangle_606hiw3_gh9zoz.png" alt="howitworks-img"/>
        </div>

        <div className="howitworks-process">
            <img src="https://res.cloudinary.com/dgkb0snud/image/upload/v1675771584/Rectangle_606hiw4_jscv4w.png" alt="howitworks-img"/>
        ...
        <div className="howitworks-process">
            ...
            <img src="https://res.cloudinary.com/dgkb0snud/image/upload/v1675771584/Rectangle_606hiw5_yeam0l.png" alt="howitworks-img"/>
        </div>

        <div className="howitworks-process">
            <img src="https://res.cloudinary.com/dgkb0snud/image/upload/v1675771583/Rectangle_606hiw6_cnidbl.png" alt="howitworks-img"/>
